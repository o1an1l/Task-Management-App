...
router.get("/board/:boardId", authenticateToken, async (req: AuthRequest, res) => {
  try {
...
// Yeni kolon oluştur
router.post("/board/:boardId", authenticateToken, async (req: AuthRequest, res) => {
  try {
    const boardId = Number(req.params.boardId);
...
router.get("/:listId", authenticateToken, async (req: AuthRequest, res) => {
  try {
...
// Kolon güncelle
router.put("/:listId", authenticateToken, async (req: AuthRequest, res) => {
  try {
    const listId = Number(req.params.listId);
...
// Kolon sil
router.delete("/:listId", authenticateToken, async (req: AuthRequest, res) => {
  try {
    const listId = Number(req.params.listId);
